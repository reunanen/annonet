...
int main(int argc, char** argv) try
{
    ...
    options.add_options()
        ...
        ("confidence-multiplier", "Increase to be more confident about the estimated probabilities", cxxopts::value<double>()->default_value("1.0"))
        ("confidence-multiplier-background", "Decrease to be more confident about the estimated probabilities", cxxopts::value<double>()->default_value("1.0"))
        ;
    ...
    const double confidence_multiplier_background = options["confidence-multiplier-background"].as<double>();
    ...
    for (size_t i = 0, end = files.size(); i < end; ++i)
    {
        ...
        result_image.p = annonet_infer(net, sample.input_image, result_image.label_image, gains, detection_levels, tiling_parameters, temp, confidence_multiplier, confidence_multiplier_background);
